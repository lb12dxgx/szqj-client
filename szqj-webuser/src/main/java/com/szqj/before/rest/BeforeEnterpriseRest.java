...
@RestController
@RequestMapping("/system/beforeenterprise")
...
public class BeforeEnterpriseRest {
	...
	public RestJson list(String enterpriseName, String applyCityId, Integer enterpriseType, Integer pageNum,
			Integer size) {
		...
		if (StringUtils.isBlank(enterpriseName)) {
			...
			page = enterpriseRepository.findByApplyCityIdAndEnterpriseTypeAndName(applyCityId, enterpriseName,
					enterpriseType, pageable);
		}
	...
	public RestJson changeState(Integer state, String enterpriseId) {
